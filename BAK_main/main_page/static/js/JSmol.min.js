...
function(a){D.consoleOutput(a,"red")};aa.err.println=function(a){D.consoleOutput("undefined"==typeof a?"\r\n":null==a?"null\r\n":a+"\r\n","red")};aa.err.write=function(a,b,c){aa.err.print(String.instantialize(a).substring(b,b+c))}}(Clazz,Jmol))};Jmol.___JmolDate="$Date: 2017-02-18 13:47:36 -0600 (Sat, 18 Feb 2017) $";Jmol.___fullJmolProperties="src/org/jmol/viewer/Jmol.properties";Jmol.___JmolVersion="14.9.1";
